        ...
        builder: (context, state) {
          ...
          return Container(
            ...
            child: RefreshIndicator(
              onRefresh: cubit.getArtist,
              child: ListView.separated(
                  itemBuilder: (context, index) {
                    if((index + 1) == cubit.artists.length){
                      return Column(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          buildArtist(context, cubit.artists[index],cubit: cubit),
                          SizedBox(height: 50,)
                        ],
                      );
                    }
                    return buildArtist(context, cubit.artists[index],cubit: cubit);
                  },
